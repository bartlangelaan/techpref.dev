    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="text-center mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-3">Style Comparisons</h2>
            ...
            >
              ...
              <div className="flex items-center gap-4 text-sm">
                <div className="flex items-center gap-2">
                  <span className="font-semibold text-primary">{comparison.leftSide.stats[0]?.value}</span>
                  <span className="text-muted-foreground">{comparison.leftSide.title.replace("Team ", "").replace("Function ", "")}</span>
                </div>
                <div className="h-4 w-px bg-border" />
                <div className="flex items-center gap-2">
                  <span className="font-semibold text-foreground">{comparison.rightSide.stats[0]?.value}</span>
                  <span className="text-muted-foreground">{comparison.rightSide.title.replace("Team ", "").replace("Arrow ", "")}</span>
                </div>
              </div>
            </Link>
          ))}
