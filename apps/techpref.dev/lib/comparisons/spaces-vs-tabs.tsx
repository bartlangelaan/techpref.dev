import { TrendingUp, Code2, Clock, Eye, FileCode, Users, Zap, BarChart3 } from "lucide-react"
...
export function getSpacesVsTabsData(): ComparisonData {
  ...
  return items
    ...
    .reduce((sum, item) => {
      ...
      projects: stats.spacesProjects.length > 0
      ...
      stats: [
        { icon: <TrendingUp className="h-5 w-5" />, value: `${stats.spacesPercent}%`, label: "of analyzed repos" },
        { icon: <BarChart3 className="h-5 w-5" />, value: `${stats.spacesRepos}`, label: "repositories" },
	...
	return items
      ...
      projects: stats.tabsProjects.length > 0
      ...
      stats: [
        { icon: <TrendingUp className="h-5 w-5" />, value: `${stats.tabsPercent}%`, label: "of analyzed repos" },
        { icon: <BarChart3 className="h-5 w-5" />, value: `${stats.tabsRepos}`, label: "repositories" },
