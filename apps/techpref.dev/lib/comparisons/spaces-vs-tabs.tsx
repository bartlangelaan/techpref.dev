  ...
  return items
      ...
      stats: [
        {
          ...
          verdictDescription: "These repositories use space-based indentation (2 or 4 spaces)",
        },
        {
    ...
    bottomStats: [
      ...
      },
      {
        ...
        verdictDescription: "These repositories have inconsistent indentation or no clear preference",
      },
    ],
    conclusion: {
