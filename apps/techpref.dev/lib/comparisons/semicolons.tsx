      ...
      stats: [
        {
          ...
          verdictDescription: "These repositories consistently use semicolons at the end of statements",
        },
        {
  ...
  greet(user)
      ...
      stats: [
        {
          ...
          verdictDescription: "These repositories omit semicolons, relying on ASI",
        },
        {
          icon: <BarChart3 className="h-5 w-5" />,
    ...
    bottomStats: [
      ...
      },
      {
        ...
        verdictDescription: "These repositories have inconsistent semicolon usage",
      },
    ],
    conclusion: {
