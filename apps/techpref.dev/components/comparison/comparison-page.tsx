        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 text-center">
          ...
          <div className="flex items-center justify-center gap-8 mt-10">
            <div className="text-center">
              <p className="text-3xl font-bold text-primary">{data.leftSide.stats[0]?.value}</p>
              <p className="text-sm text-muted-foreground">Use {data.leftSide.title.replace("Team ", "")}</p>
            </div>
            <div className="h-12 w-px bg-border" />
            <div className="text-center">
              <p className="text-3xl font-bold text-foreground">{data.rightSide.stats[0]?.value}</p>
              <p className="text-sm text-muted-foreground">Use {data.rightSide.title.replace("Team ", "")}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        <div className="mt-16 lg:mt-24 text-center">
          <div className="inline-flex flex-col items-center p-8 rounded-2xl border border-border bg-card">
            ...
            <h3 className="text-xl font-bold text-foreground mb-2">{data.conclusion.title}</h3>
